...
#ifndef VK_INHERITED_VIEWPORT_FRAMEMANAGER_HPP_
#define VK_INHERITED_VIEWPORT_FRAMEMANAGER_HPP_
...
public:
  ...
  FrameManager(
      ...
      , m_presentQueue(
            (ctx.setGCTQueueWithPresent(surface), ctx.m_queueGCT.queue))
      , m_wantVsync(vsync)
      , m_width(width)
      , m_height(height)
  {
...
public:
  ...
  bool inBeginEndPair() const { return m_userCommandBuffer != VK_NULL_HANDLE; }
